...
data = dict(
    ...
    train=dict(
        ...
        ann_file=data_root + 'train_5Inst_ID_6Cat_3Inst_OOD/annos/annotations.json',
        img_prefix=data_root + 'train_5Inst_ID_6Cat_3Inst_OOD/images',
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        classes=syn_ycbv_cs_classes,
        ann_file=data_root + 'test_5Inst_ID/annos/annotations.json',
